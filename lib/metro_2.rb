...
module Metro2
  class Metro2File
    ...
    def header
      ...
      contents << date_field(header_contents.activity_date, 8)
      contents << date_field(header_contents.created_date, 8)
      contents << date_field(header_contents.program_date, 8)
